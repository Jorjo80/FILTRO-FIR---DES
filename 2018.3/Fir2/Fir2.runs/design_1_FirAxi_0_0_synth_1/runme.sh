...
HD_PWD='H:/Jorge/UPM/master/1erCuatri/DES/Trabajo_filtroFIR/FILTRO-FIR---DES/Fir2/Fir2.runs/design_1_FirAxi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FirAxi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FirAxi_0_0.tcl
