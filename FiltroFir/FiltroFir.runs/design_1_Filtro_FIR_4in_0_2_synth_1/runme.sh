...
HD_PWD='H:/Jorge/UPM/master/1erCuatri/DES/Trabajo_filtroFIR/FILTRO-FIR---DES/FiltroFir/FiltroFir.runs/design_1_Filtro_FIR_4in_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Filtro_FIR_4in_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Filtro_FIR_4in_0_2.tcl
