...
HD_PWD='H:/Jorge/UPM/master/1erCuatri/DES/Trabajo_filtroFIR/FILTRO-FIR---DES/FiltroFir/FiltroFir.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Filtro_FIR_4in.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Filtro_FIR_4in.tcl
