...
proc create_root_design { parentCell } {
  ...
  # Create instance: Filtro_FIR_4in_0, and set properties
  set Filtro_FIR_4in_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Filtro_FIR_4in:1.0 Filtro_FIR_4in_0 ]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Filtro_FIR_4in_0/i_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins Filtro_FIR_4in_0/i_rstb] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins Filtro_FIR_4in_0/i_coeff_0] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins Filtro_FIR_4in_0/i_coeff_1] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins Filtro_FIR_4in_0/i_coeff_3] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins Filtro_FIR_4in_0/i_coeff_2] [get_bd_pins xlconstant_3/dout]
