...
HD_PWD='c:/users/pract/desktop/filtrofir/project_1/project_1.tmp/firaxi_v17_1_project/FirAxi_v17_1_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirAxi_v6_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirAxi_v6_0.tcl
