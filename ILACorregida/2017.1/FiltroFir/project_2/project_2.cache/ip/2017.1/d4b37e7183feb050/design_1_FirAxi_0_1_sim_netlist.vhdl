...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Filtro_FIR_4in is
  ...
  signal newdata_reg_i_2_n_0 : STD_LOGIC;
...
newdata_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"CA"
    )
        port map (
...
newdata_i_10: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
newdata_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
newdata_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
newdata_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
newdata_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
newdata_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
newdata_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
newdata_i_9: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
