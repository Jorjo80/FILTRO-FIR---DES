...
proc create_root_design { parentCell } {
  ...
  set FirAxi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:FirAxi:8.0 FirAxi_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins FirAxi_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
