...
HD_PWD='c:/users/pract/desktop/filtrofir/project_2/project_2.tmp/firaxi_v8_0_project/FirAxi_v8_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirAxi_v8_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirAxi_v8_0.tcl
