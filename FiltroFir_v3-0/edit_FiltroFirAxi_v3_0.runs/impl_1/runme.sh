...
HD_PWD='H:/Jorge/UPM/master/1erCuatri/DES/Trabajo_filtroFIR/FILTRO-FIR---DES/FiltroFir_v3-0/edit_FiltroFirAxi_v3_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FiltroFirAxi_v3_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FiltroFirAxi_v3_0.tcl -notrace
