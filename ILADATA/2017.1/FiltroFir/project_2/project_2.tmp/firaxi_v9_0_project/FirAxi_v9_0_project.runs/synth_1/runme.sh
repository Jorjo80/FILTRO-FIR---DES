...
HD_PWD='c:/users/pract/desktop/conila/2017.1/filtrofir/project_2/project_2.tmp/firaxi_v9_0_project/FirAxi_v9_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirAxi_v9_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirAxi_v9_0.tcl
