...
HD_PWD='H:/Jorge/UPM/master/1erCuatri/DES/Trabajo_filtroFIR/FILTRO-FIR---DES/ip_repo/edit_FiltroFir_AXI_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FiltroFir_AXI_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FiltroFir_AXI_v1_0.tcl
