...
read_vhdl -library "" {
  H:/Jorge/UPM/master/1erCuatri/DES/Trabajo_filtroFIR/FILTRO-FIR---DES/ip_repo/FiltroFir_AXI_1.0/hdl/FiltroFir_AXI_v1_0_S00_AXI.vhd
...
synth_design -top FiltroFir_AXI_v1_0 -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef FiltroFir_AXI_v1_0.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file FiltroFir_AXI_v1_0_utilization_synth.rpt -pb FiltroFir_AXI_v1_0_utilization_synth.pb"
