...
HD_PWD='H:/Jorge/UPM/master/1erCuatri/DES/Trabajo_filtroFIR/FILTRO-FIR---DES/ip_repo/edit_FiltroFir_AXI_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FiltroFir_AXI_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FiltroFir_AXI_v1_0.tcl -notrace
