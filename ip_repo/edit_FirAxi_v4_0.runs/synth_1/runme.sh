...
HD_PWD='h:/jorge/upm/master/1ercuatri/des/trabajo_filtrofir/filtro-fir---des/ip_repo/edit_FirAxi_v4_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirAxi_v4_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirAxi_v4_0.tcl
