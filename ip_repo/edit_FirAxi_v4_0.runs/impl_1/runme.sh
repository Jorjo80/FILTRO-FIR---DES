...
HD_PWD='h:/jorge/upm/master/1ercuatri/des/trabajo_filtrofir/filtro-fir---des/ip_repo/edit_FirAxi_v4_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FirAxi_v4_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FirAxi_v4_0.tcl -notrace
